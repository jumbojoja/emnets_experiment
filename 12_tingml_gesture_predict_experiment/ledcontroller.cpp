 ...
 * off. gpio_init(gpio_pin, GPIO_OUT); gpio_write(pin, 0);
 */
 ...
 * the current LED state. void gpio_write(uint8_t pin, int value);
 ...
 * the LED to the current LED state. void gpio_set(uint8_t pin); void
